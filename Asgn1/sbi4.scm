...
;;(define (sbi-dim arglist))

;;(define (sbi-let arglist))

;;(define (sbi-goto arglist))

;;(define (sbi-if arglist))

;;(define (sbi-print arglist))

;;(define (sbi-input arglist))

;;(define (eval-expr mathexpr))
